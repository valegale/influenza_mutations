...
path_results = "results_html"
if not os.path.exists(path_results):
   os.makedirs(path_results)
   print("A new folder called results_html has been created")
...
for i in range(int(bin_start[0:2]), int(bin_end[0:2])):
	...
	create_document(name_file, bin1, bin2, min_support, net, G_cooccurring, key_mutations, single_mutation_support, co_occurring, N_sites_prediction, N_sites_reverse)
...
create_clusters_summary_document(data_table_clusters)